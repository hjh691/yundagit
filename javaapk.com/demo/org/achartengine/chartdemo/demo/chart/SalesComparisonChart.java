...
public class SalesComparisonChart extends AbstractDemoChart {
  ...
  public Intent execute(Context context) {
    ...
    values.add(new double[] { 14230, 12300, 14240.123234, 15244, 14900, 12200, 11030, 12000, 12500,
        15500, 14600, 15000 });
    values.add(new double[] { 10230, 10900, 11240, 12540.141423, 13500, 14200, 12530, 11200, 10500,
        12500, 11600, 13500 });
