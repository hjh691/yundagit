...
public class BluetoothActivity extends  Activity{
	 ...
	 Handler LinkDetectedHandler=new Handler(){
		@Override
		 public void handleMessage(Message msg){
			...
			myList.setSelection(msgList.size()-1);
		}
	};
	
	@Override
	protected void onResume(){
		BluetoothMsg.serviceOrCilent=BluetoothMsg.serviceOrCilent.CILENT;
    ...
    private class clientThread extends Thread {           
        ...
        public void run() {  
			...
			Bluetoothclient.mBluetoothLeService.connect(BluetoothMsg.BlueToothAddress);
