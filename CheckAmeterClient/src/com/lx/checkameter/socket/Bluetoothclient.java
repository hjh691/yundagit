...
public class Bluetoothclient extends Activity implements OnItemClickListener{
    ...
    private void setBluetooth(){  
    	...
    	//blueadapter=BluetoothAdapter.getDefaultAdapter();  
            ...
            else{   //Device does not support Bluetooth  不支持蓝牙通讯。
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int pos, long arg3) {
        ...
        Log.e("msgChildView", "ChildView= "+arg0.getChildAt(pos-arg0.getFirstVisiblePosition()));  
            ...
            if(blueadapter!=null&&blueadapter.isDiscovering()){  
                blueadapter.cancelDiscovery();  //停止搜索进程
                    ...
                    new DialogInterface.OnClickListener() {  
                        ...
                        public void onClick(DialogInterface dialog, int which) {  
                            ...
                            if(BluetoothMsg.lastblueToothAddress!=BluetoothMsg.BlueToothAddress){  
                                ...
                                mBluetoothLeService.connect(BluetoothMsg.BlueToothAddress);
                            }  
                            mBluetoothLeService.connect(BluetoothMsg.BlueToothAddress);  
                            Intent in=new Intent(Bluetoothclient.this,BluetoothActivity.class);  
                            startActivity(in);  
