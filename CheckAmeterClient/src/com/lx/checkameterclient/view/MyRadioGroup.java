            ...
            ((RadioButton) child).setOnTouchListener(new OnTouchListener() {  
                ...
                public boolean onTouch(View v, MotionEvent event) {  
                    ...
                    if(mOnCheckedChangeListener != null){  
                        ...
                        //----------
//                        MyRadioGroup.this.check(child.getId()); 
                    }  
                    return true;  
                }  
            });  
              
        } else if(child instanceof LinearLayout){   //如果是自定义的MyRadioGroup对象
            ...
            for(int i = 0; i < childCount; i++){  
                ...
                if (view instanceof RadioButton) {  
                    ...
                    //自己添加的代码，解决布局加载后mCheckId没有初始化的问题
                    if(button.isChecked()){
                    	this.mCheckedId = button.getId();
                    }
                ...
                for(int j = 0; j < childCount; j++){  
                    ...
                    if (view instanceof RadioButton) {  
                        ...
                        if(button == radioButton){  
                            // do nothing  
                        	//自己添加的代码，解决多行RadioButton切换选项时的mCheckedId值的更新问
