 ...
 * 导航栏视图组�?
 */
public class NavigationBarHScrollView extends HorizontalScrollView {
	/** 传入整体布局  */
	...
	public NavigationBarHScrollView(Context context) {
		super(context);
	}

	public NavigationBarHScrollView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
