...
public class SlidingMenuControlller implements OnClickListener{
	...
	private void initView() {
		...
		if(Declare.islogin){
			...
			username.setText("未登录");//显示用户名称或未登录
		}
	...
	public void onClick(View v) {
		...
		case R.id.lay_help://操作说明
			//Intent intent = new Intent(activity, LaunchSimpleActivity.class);
			//activity.startActivity(intent);
			activity.startActivity(new Intent(activity,Activity_help.class));
