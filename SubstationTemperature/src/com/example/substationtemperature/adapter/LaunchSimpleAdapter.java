...
public class LaunchSimpleAdapter extends PagerAdapter {
	...
	public LaunchSimpleAdapter(Context context,int[] imageArray){
		...
		for(int i=0;i<imageArray.length;i++){
			View view=mInflater.inflate(R.layout.splash_activity, null);
			ImageView iv_launch=(ImageView)view.findViewById(R.id.imageView1);
			RadioGroup rg_indicate=(RadioGroup)view.findViewById(R.id.radioGroup1);
			Button btn_start=(Button)view.findViewById(R.id.btn_xiangqing);
			...
			if(i==imageArray.length-1){
				...
				btn_start.setOnClickListener(new OnClickListener(){
					...
					public void onClick(View v){
						Toast.makeText(mContext, "欢迎您开启美好生活", Toast.LENGTH_LONG).show();
